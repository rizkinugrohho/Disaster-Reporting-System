...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  ...
  <div class="row my-4">
    <div class="col-md-5">
      <a href="laporan_form_tambah.php" class="btn btn-success">Tambah Data Bencana</a>
    </div>
  </div>
        ...
        <tbody>
          ...
          <?php while ($data = mysqli_fetch_assoc($result)): ?>
            <tr>
              ...
              <td><?=$data['nama_kec']?></td>
              <td>
                <a href="laporan_form_ubah.php?nis=<?=$data['nis']?>" class="badge text-bg-primary text-decoration-none">Ubah</a>
                <a href="laporan_proses_hapus.php?nis=<?=$data['nis']?>" class="badge text-bg-danger text-decoration-none" onclick="return confirm('Yakin ingin dihapus?')">Hapus</a>
              </td>
            </tr>
            <?php $no++;?>
          <?php endwhile;?>
